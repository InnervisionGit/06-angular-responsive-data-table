...
let xhReq:XMLHttpRequest = new XMLHttpRequest();
const dataUrl:string = "http://localhost:3000/products";
xhReq.open("GET", dataUrl, false);
xhReq.send(null);
let dataJSON: DataTableItem[] = JSON.parse(xhReq.responseText);

// TODO: replace this with real data from your application
const EXAMPLE_DATA: DataTableItem[] = dataJSON;
